...
- **Global scope**: `/Users/cayley/work/superset/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/cayley/work/superset/.claude/notes/`)
...
2. Glob `/Users/cayley/work/superset/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/cayley/work/superset/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/cayley/work/superset/.claude/notes/` — works in any directory
